...
const VideoTestimonialCard = () => {
  return (
    <Card className="max-w-[420px] mx-auto bg-card shadow-medium rounded-2xl p-6 text-center animate-fade-in">
      ...
      <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-xl mb-4">
        <iframe 
          src="https://www.youtube.com/embed/P0M8IG1Z28w?si=0hy6cMhHm5OKSQ2q"
      ...
      <div className="mt-4 text-foreground font-medium">
        Rajesh Kumar &mdash; Tech Solutions Pvt Ltd
      </div>
